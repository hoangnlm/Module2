...
public class CustomerPanel extends javax.swing.JPanel {
    ...
    private void fetchCustomerDetails() {
        ...
        selectedCustomer.setCusID((int) tbCustomerList.getValueAt(selectedRow, 0));
        selectedCustomer.setCusName((String) tbCustomerList.getValueAt(selectedRow, 1));
        selectedCustomer.setCusLevel((int) tbCustomerList.getValueAt(selectedRow, 2));
        selectedCustomer.setCusPhone((String) tbCustomerList.getValueAt(selectedRow, 3));
        selectedCustomer.setCusAddress((String) tbCustomerList.getValueAt(selectedRow, 4));
        selectedCustomer.setCusEnabled((boolean) tbCustomerList.getValueAt(selectedRow, 5));
    ...
    private void resetCustomerDetails() {
        ...
        cbCusEnabled.setSelected(false);
    }
...
//</editor-fold>
    ...
    private void insertAction() {
        if (!isFinished) {
            ...
            customerTableModel.insert(customer);
            isFinished = false;
            setCursor(null);
        }
    }
    ...
    private void updateAction() {
        if (!isFinished) {
            ...
            customerTableModel.update(selectedCustomer);
            isFinished = false;
            setCursor(null);
        }
    }
    ...
    private void deleteAction() {
        setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        customerTableModel.delete(selectedCustomer);
        tbCustomerList.getSelectionModel().clearSelection();
        setCursor(null);
    }
