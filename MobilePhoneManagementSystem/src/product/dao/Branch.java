...
public class Branch {
    ...
    public static final String Query_Show = "select braid,braname,braEnabled,suppliers.supname,suppliers.supid from branches join suppliers on suppliers.supid=branches.supid where BraEnabled = 1 order by braid desc";
